...
public class InputParserTest {
    ...
    public void return_basket_with_one_kind_of_no_taxed_item() {
        ...
        assertThat(basket.getItemList().get(0), is(Item.createItemFrom(2, new Price("12.49"), "book", false)));
    }
    ...
    public void return_basket_when_item_has_imported_word_at_the_beginning() {
        ...
        assertThat(basket.size(), is(1));
        assertThat(basket.getItemList().get(0), is(Item.createItemFrom(1, new Price("10.00"), "box of chocolates", true)));
    }
    ...
    public void return_basket_with_one_kind_of_taxed_item() {
        ...
        assertThat(basket.size(), is(1));
        assertThat(basket.getItemList().get(0), is(Item.createItemFrom(1, new Price("14.99"), "music CD", false)));
    }
    ...
    public void return_basket_with_more_than_one_kind_of_item() {
        ...
        assertThat(basket.getItemList(), contains(
                Item.createItemFrom(2, new Price("12.49"), "book", false),
                Item.createItemFrom(1, new Price("14.99"), "music CD", false),
                Item.createItemFrom(1, new Price("0.85"), "chocolate bar", false))
        );
    }
}